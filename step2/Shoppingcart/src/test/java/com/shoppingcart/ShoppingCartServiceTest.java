...
public class ShoppingCartServiceTest {
	...
	@Test
	public void addSimilarProductMultipleTimes() throws ShoppingCartException {
		Product doapSoap = getProduct();
		int quantity = 5;

		Product doapSoap2 = getProduct();
		int newQuantity = 3;
	...
	@DisplayName("Given same product added multiple quantities When CheckOut Then is should match the final invoice amount")
	@Test
	public void checkOutSimilarProducts() throws ShoppingCartException {
		Product doapSoap = getProduct();
		int quantity = 5;
		...
		testInstance.addProductToCart(doapSoap, newQuantity);
		testInstance.addProductToCart(doapSoap2, quantity);
